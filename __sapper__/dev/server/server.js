...
const Routes = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<div class="${"section "}" id="${"section0"}">
  <ul class="${"about"}"><li class="${"contentbox"}"><h4 id="${"formatfont"}">Here at KBL, we aim to help you maximise your Marketing efforts by supplying you with good quality
...
so if you can’t see what you’re looking for give us a call, we are sure we will be able to help!<br>
    <br>
        Read more about us <a href="${"aboutus.html"}" class="${"point"}">here</a></h4></li></ul>

  
    <div class="${"section"}" id="${"section1"}"><br>
      <h1 class="${"pands"}" id="${"gone"}">Products and Services</h1>
      <br>
      
       <div class="${"swiper-container"}"><div class="${"swiper-wrapper"}"><div class="${"swiper-slide"}"><p class="${"time"}">Forecourt/Pavement Signs</p>
             <a href="${"forecourt.html"}"><img src="${"img/sign/forecourt/26.jpg"}" alt="${""}" class="${"img-box"}"></a>
               <div class="${"cart"}"><a href="${"forecourt.html"}">Find out more</a></div></div>
           <div class="${"swiper-slide"}"><p class="${"time"}">Covid 19</p>
             <a href="${"covid19.html"}"><img src="${"img/sign/covid/48.jpg"}" alt="${""}" class="${"img-box"}"></a>
               <div class="${"cart"}"><a href="${"covid19.html"}">Find out more</a></div></div>
           <div class="${"swiper-slide"}"><p class="${"time"}">Compact Privacy Screen</p>
             <a href="${"compact.html"}"><img src="${"img/sign/compact/42.jpg"}" alt="${""}" class="${"img-box"}"></a>
               <div class="${"cart"}"><a href="${"compact.html"}">Find out more</a></div></div>
           <div class="${"swiper-slide"}"><p class="${"time"}">A-Board Pavement Sign</p>
             <a href="${"aboard.html"}"><img src="${"img/sign/aboard/2.jpg"}" alt="${""}" class="${"img-box"}" id="${"correct"}"></a>
               <div class="${"cart"}"><a href="${"aboard.html"}">Find out more</a></div></div>
           <div class="${"swiper-slide"}"><p class="${"time"}">Lockable Poster Cases</p>
             <a href="${"lockposter.html"}"><img src="${"img/sign/lockposter/5.jpg"}" alt="${""}" class="${"img-box"}" id="${"correct"}"></a>
               <div class="${"cart"}"><a href="${"lockposter.html"}">Find out more</a></div></div>
           <div class="${"swiper-slide"}"><p class="${"time"}">Menu / Floor Standing Displays / Info Holders</p>
             <a href="${"menuselect.html"}"><img src="${"img/sign/menu/31.jpg"}" alt="${""}" class="${"img-box"}"></a>
               <div class="${"cart"}"><a href="${"menuselect.html"}">Find out more</a></div></div>
           <div class="${"swiper-slide"}"><p class="${"time"}">Snap Frames</p>
             <a href="${"snapframe.html"}"><img src="${"img/sign/snap/38.jpg"}" alt="${""}" class="${"img-box"}"></a>
               <div class="${"cart"}"><a href="${"snapframe.html"}">Find out more</a></div></div>
           <div class="${"swiper-slide"}"><p class="${"time"}">Replacement Front Sheets</p>
             <a href="${"replacement.html"}"><img src="${"img/sign/frontsheet/.jpg"}" alt="${""}" class="${"img-box"}"></a>
               <div class="${"cart"}"><a href="${"replacement.html"}">Find out more</a></div></div>
           <div class="${"swiper-slide"}"><p class="${"time"}">Illuminated Displays</p>
             <a href="${"illuminated.html"}"><img src="${"img/sign/illuminated/45.jpg"}" alt="${""}" class="${"img-box"}"></a>
               <div class="${"cart"}"><a href="${"illuminated.html"}">Find out more</a></div></div>
           <div class="${"swiper-slide"}"><p class="${"time"}">Roller Banners</p>
             <a href="${"rollerbanner.html"}"><img src="${"img/sign/covid/56.jpg"}" alt="${""}" class="${"img-box"}"></a>
               <div class="${"cart"}"><a href="${"rollerbanner.html"}">Find out more</a></div></div></div>
...
<article class="${"content-body svelte-12hdsyz"}"><h1 class="${"svelte-12hdsyz"}">Testimonials</h1>
<section class="${"section-name padding-y testimonials svelte-12hdsyz"}"><ul class="${"testimonials svelte-12hdsyz"}"><li class="${"bubble bubble-bottom-left svelte-12hdsyz"}" id="${"one"}">&quot;We have worked with KBL Solutions on more than one occasion and have always found them to be
    Very efficient, easy to communicate with and very reliable whilst meeting difficult deadlines.We will continue to work with them on future projects. Would highly recommend.&quot;
    <br><br>
    <h6 class="${"svelte-12hdsyz"}">Commercial Project &amp; Supply Chain Controller - Astley</h6></li>
  <li class="${"bubble bubble-bottom-left svelte-12hdsyz"}" id="${"five"}">&quot;KBL solutions delivered a brilliant service when we needed a very quick turnaround on an order. Great communication, efficient delivery and excellent quality product. Highly recommend Karen, will definitely be using KBL solutions going forward.&quot;
  <br><br>
  <h6 class="${"svelte-12hdsyz"}">Managing Director - Sip It</h6></li>
  <li class="${"bubble bubble-bottom-left svelte-12hdsyz"}" id="${"three"}">&quot;I have found KBL Solutions to be a great company to work with, speedy responses,  competitive prices supplying us with good quality products.
    Any issues are dealt with quickly and professionally.  They couldn’t be more helpful.&quot;
  <br><br>
  <h6 class="${"svelte-12hdsyz"}">Project Support Coordinator - Dreams</h6></li>
    <li class="${"bubble bubble-bottom-left svelte-12hdsyz"}" id="${"three"}">“I’m always happy to work with Karen at KBL. They are friendly, approachable and good communicators. They provide a prompt service. Keep up the good work”
    <br><br>
    <h6 class="${"svelte-12hdsyz"}">Inventory Administrator - Tate Business Group</h6></li>
    <li class="${"bubble bubble-bottom-left svelte-12hdsyz"}" id="${"five"}">&quot;We have always found Karen @ KBL Solutions to be extremely helpful and efficient with any orders we place with her.  The service we receive is second-to-none.&quot;
    <br><br>
    <h6 class="${"svelte-12hdsyz"}">Majestic Wines</h6></li></ul></section></article>`;
});
...
const css$1 = {
	code: ".svelte-gau6c.svelte-gau6c{list-style:none}ul.svelte-gau6c.svelte-gau6c{display:flex;flex-direction:row;flex-wrap:wrap}ul.svelte-gau6c li.svelte-gau6c{margin:20px}",
	map: "{\"version\":3,\"file\":\"[slug].svelte\",\"sources\":[\"[slug].svelte\"],\"sourcesContent\":[\"<script context=\\\"module\\\">\\n\\texport async function preload({ params, query }) {\\n\\t\\t// the `slug` parameter is available because\\n        // this file is called [slug].svelte\\n\\t\\tconst res = await this.fetch(`products/landing/${params.slug}.json`);\\n\\t\\tconst data = await res.json();\\n\\t\\tif (res.status === 200) {\\n\\t\\t\\treturn { group: data };\\n\\t\\t} else {\\n\\t\\t\\tthis.error(res.status, data.message);\\n\\t\\t}\\n\\t}\\n</script>\\n\\n<script>\\n\\texport let group;\\n</script>\\n\\n<style>\\n*{\\n\\tlist-style: none;\\n}\\nul{\\n\\tdisplay: flex;\\n\\tflex-direction: row;\\n\\tflex-wrap: wrap;\\n}\\nul li{\\n\\tmargin: 20px;\\n}\\n</style>\\n\\n<h1>{group.name}</h1>\\n\\n<ul>\\n    {#each group.products as product}\\n        <li>\\n\\t\\t\\t<a href=\\\"/products/{product.slug}\\\">\\n\\n\\t\\t\\t\\t<!-- The [0] means get the first image from the array -->\\n\\t\\t\\t\\t<img src={group.images[0].src} alt={group.images[0].alt} />\\n\\n\\t\\t\\t\\t<h2>{product.name}</h2>\\n\\t\\t\\t\\t<p>From £{product.price}</p>\\n\\t\\t\\t</a>\\n        </li>\\n    {/each}\\n</ul>\\n\"],\"names\":[],\"mappings\":\"AAmBA,0BAAC,CAAC,AACD,UAAU,CAAE,IAAI,AACjB,CAAC,AACD,4BAAE,CAAC,AACF,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,GAAG,CACnB,SAAS,CAAE,IAAI,AAChB,CAAC,AACD,eAAE,CAAC,eAAE,CAAC,AACL,MAAM,CAAE,IAAI,AACb,CAAC\"}"
};
...
const U5Bslugu5D = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<h1 class="${"svelte-gau6c"}">${escape(group.name)}</h1>

<ul class="${"svelte-gau6c"}">${each(group.products, product => `<li class="${"svelte-gau6c"}"><a href="${"/products/" + escape(product.slug)}" class="${"svelte-gau6c"}">
				<img${add_attribute("src", group.images[0].src, 0)}${add_attribute("alt", group.images[0].alt, 0)} class="${"svelte-gau6c"}">

				<h2 class="${"svelte-gau6c"}">${escape(product.name)}</h2>
				<p class="${"svelte-gau6c"}">From £${escape(product.price)}</p></a>
        </li>`)}</ul>`;
});
...
${($$result.head += `${($$result.title = `<title>${escape(products.name)} - KBL Solutions</title>`, "")}`, "")}

<article class="${"card svelte-1lkfewi"}"><div class="${"row no-gutters svelte-1lkfewi"}"><aside class="${"col-sm-6 border-right svelte-1lkfewi"}"><article class="${"gallery-wrap svelte-1lkfewi"}"><div class="${"img-big-wrap svelte-1lkfewi"}">
    ${products.images
	? `<figure class="${"svelte-1lkfewi"}">${each(products.images, ({ alt, src }) => `<img${add_attribute("alt", alt, 0)}${add_attribute("src", src, 0)} class="${"svelte-1lkfewi"}">`)}</figure>`
	: ``}</div> </article> </aside>
	 	<main class="${"col-sm-6 svelte-1lkfewi"}"><article class="${"content-body svelte-1lkfewi"}"><h1 class="${"title svelte-1lkfewi"}">${escape(products.name)}</h1>
							<p class="${"svelte-1lkfewi"}">${escape(products.teaser)}</p>
        
        ${products.features
	? `<ul class="${"list-check mb-4 svelte-1lkfewi"}">${each(products.features, feature => `<li class="${"svelte-1lkfewi"}">${escape(feature)}</li>`)}</ul>`
	: ``}
				<span class="${"price h4 svelte-1lkfewi"}">${products.price
	? `<h2 class="${"svelte-1lkfewi"}">£${escape(products.price)}</h2>`
	: ``}</span></article></main>

        </div></article>
<section class="${"section-name padding-y bg svelte-1lkfewi"}"><div class="${"container svelte-1lkfewi"}"><div class="${"row svelte-1lkfewi"}"><div class="${"content svelte-1lkfewi"}"><div class="${"col-md-8 svelte-1lkfewi"}"><h3 class="${"title-description svelte-1lkfewi"}">Description</h3>
	        <p class="${"svelte-1lkfewi"}">${escape(products.description)}</p>

	        
	        ${products.downloads
	? `<ul class="${"svelte-1lkfewi"}">${each(products.downloads, ({ name, file }) => `<li class="${"svelte-1lkfewi"}"><img src="${"img/pdf.jpg"}" alt="${"PDF Download"}" class="${"pdf svelte-1lkfewi"}"><a${add_attribute("href", file, 0)} class="${"svelte-1lkfewi"}">${escape(name)}</a>
	                    </li>`)}</ul>`
	: ``}

        <h3 class="${"svelte-1lkfewi"}">Specifications</h3>
					<table class="${"table table-bordered svelte-1lkfewi"}"><dl class="${"svelte-1lkfewi"}">${each(products.specifications, ({ label, value }) => `<dt class="${"svelte-1lkfewi"}">${escape(label)}</dt>
                ${value
	? `<dd class="${"svelte-1lkfewi"}">${escape(value)}</dd>`
	: ``}`)}</dl></table></div>
...
/* src/routes/terms.svelte generated by Svelte v3.23.2 */
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<header class="${"section-header"}"><section class="${"border-bottom"}"><nav class="${"navbar navbar-main navbar-expand-lg navbar-light"}">
		<div class="${"container"}"><a class="${"navbar-brand"}" href="${"index"}"><img src="${"img/logo.png"}" alt="${"KBL Solutions logo"}" class="${"svelte-1xpge2h"}"></a>
			...
			<div class="${"collapse navbar-collapse"}" id="${"main_nav1"}"><ul class="${"navbar-nav mr-auto"}"><li class="${"nav-item"}"><a class="${"nav-link"}" href="${"/index"}">Home </a></li>
					...
					<li class="${"nav-item dropdown"}"><a class="${"nav-link dropdown-toggle"}" data-toggle="${"dropdown"}" href="${"/products/index.svelte"}">Products and Services</a>
						<div class="${"dropdown-menu"}"><a class="${"dropdown-item"}" href="${"/products/index"}">All products and services</a>
						<div class="${"dropdown-divider"}"></div>
						<a class="${"dropdown-item"}" href="${"/products/landing/covid-19"}">Covid 19</a>
						<div class="${"dropdown-divider"}"></div>
							<a class="${"dropdown-item"}" href="${"/products/compact-screen"}">Compact Privacy Screen</a>
						...
						</li><li class="${"nav-item"}"><a class="${"nav-link"}" href="${"/products/landing/covid-19"}">Covid 19</a></li>
						<li class="${"nav-item"}"><a class="${"nav-link"}" href="${"testimonials"}">Testimonials</a></li>
					<li class="${"nav-item"}"><a class="${"nav-link"}" href="${"index.html#section2"}">Contact</a></li></ul>
