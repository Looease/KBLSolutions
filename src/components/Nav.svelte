  ...
  <div class="utility-bar">
    <div class="utility-inner">
      <div class="utility-contacts">
        ...
        <a class="utility-link utility-email" href="mailto:info@kblsolutions.co.uk">
      ...
      <span class="utility-tagline">KBL Solutions — B2B Marketing Display &amp; POS Specialists</span>
    </div>
  </div>
...
<style>
  ...
  @media (min-width: 640px) { .utility-email { display: flex; } }
