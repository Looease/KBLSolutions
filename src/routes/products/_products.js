const products = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        name: "Swinger 3 Swing Sign Panel with poster pocket (water fillable polyethylene base) Unprinted",
        teaser: "Our top selling Swinger model. Contact us for print prices",
        images: [
          {
            alt: "Swinger 3",
        ...
        subprice: [
          {
            text: `White - With top poster pocket - Unprinted`,
          ...
          {
            text: `Black - With top poster pocket - Unprinted`,
            productCode: `S3SSPSTR2030BLK `,
            quantityOpt1: `1-9`,
            priceOpt1: `£133.00`,
            quantityOpt2: "",
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        images: [
          {
            alt: "Snap Frames 25mm Mitred corners",
            src: "/img/sign/snap/23oo.jpg",
          },
          {
            alt: "Snap Frames 25mm Mitred corners",
            src: "/img/sign/snap/8.jpg",
          },
        ],
        features: [
          "25 extruded aluminum frame",
  ...
  },
  {
    ...
    products: [
      ...
      {
        slug: "key-lock-frame-ppc",
        name: "Secure Wall PPC - Key Lock Frame",
        teaser:
          "Our Key Lock Frame range is high specification system which is ideal for outdoor locations.",
        images: [
          {
